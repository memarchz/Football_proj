...
# 1. โหลดข้อมูล
# =========================================================
print("🚀 เริ่มระบบ V5.1 FULL OPTION: Strict + Momentum + DC Analysis...")
...
# =========================================================
# [NEW] คำนวณราคา Double Chance เพื่อการวิเคราะห์
# =========================================================
# ป้องกันการหารด้วย 0
full_data = full_data[(full_data['AvgH'] > 0) & (full_data['AvgD'] > 0) & (full_data['AvgA'] > 0)]

# คำนวณ Implied Odds สำหรับ Double Chance
# สูตร: 1 / ( (1/Odd1) + (1/Odd2) )
full_data['AvgDC_1X'] = 1 / ((1/full_data['AvgH']) + (1/full_data['AvgD']))
full_data['AvgDC_12'] = 1 / ((1/full_data['AvgH']) + (1/full_data['AvgA']))
full_data['AvgDC_X2'] = 1 / ((1/full_data['AvgD']) + (1/full_data['AvgA']))
...
# =========================================================
# [UPDATE] เพิ่ม AvgDC เข้าไปใน Features
features = ['AvgH', 'AvgD', 'AvgA', 'AvgDC_1X', 'AvgDC_12', 'AvgDC_X2'] + cols_new
X = final_df[features]
...
print(f"🧠 กำลังเทรน V5.1 (Train: {len(X_train)} | Test: {len(X_test)})...")
...
print(f"\n{'='*130}")
print(f"🔬 V5.1 REALITY CHECK (Detailed 5% Intervals + DC Factors)")
...
joblib.dump(eclf, 'model_v5_sniper_dc.pkl')
print(f"\n💾 บันทึกโมเดล V5.1 (DC Enabled) และตารางวิเคราะห์เรียบร้อย!")