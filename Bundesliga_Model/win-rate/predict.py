...
urls = ["https://www.football-data.co.uk/mmz4281/2526/D1.csv", # Season 25/26
...
try:
    model = joblib.load('model_v5_bundesliga.pkl')
...
# =========================================================
upcoming_matches = [
   {"Home": "Hamburg",   "Away": "Bayern Munich","Odds": [9.15, 6.2, 1.343]}
