...
urls = ["https://www.football-data.co.uk/mmz4281/2526/SP1.csv", # Season 25/26
...
try:
    model = joblib.load('model_v5_laliga.pkl')
...
# =========================================================
upcoming_matches = [
    {"Home": "Girona",          "Away": "Barcelona",    "Odds": [7.71, 5.91, 1.368]}
