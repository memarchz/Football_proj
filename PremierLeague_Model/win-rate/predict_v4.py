...
try:
    model = joblib.load('model_v5_sniper.pkl')
...
# =========================================================
upcoming_matches = [
   {"Home": "Man City",      "Away": "Fulham",         "Odds": [1.408, 5.23, 8.0]},
    {"Home": "Aston Villa",   "Away": "Brighton",       "Odds": [2.102, 3.755, 3.655]},
    {"Home": "Crystal Palace","Away": "Burnley",        "Odds": [1.525, 4.625, 6.96]},
    {"Home": "Nott'm Forest", "Away": "Wolves",         "Odds": [1.747, 4.0, 5.18]},
    {"Home": "Sunderland",    "Away": "Liverpool",      "Odds": [4.625, 4.045, 1.811]}
